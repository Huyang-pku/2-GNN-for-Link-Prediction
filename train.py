...
from utils.tool import get_ei2, to_directed, reverse, reduce_loops, to_undirected_index
from GNN.model import GCN, WLGNN
...
def val_params(dim1, dim2, depth, lr, **kwargs):
...
def sel_params(trial: optuna.Trial):
    ...
    dim2 = trial.suggest_categorical("dim1", [16, 32, 64, 128, 256])
